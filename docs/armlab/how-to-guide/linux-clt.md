...
{: .note}
This is exactly the fix referenced in the [Setup Guide](/docs/armlab/setup-guide#installation). A script that is not executable also will not Tab-complete, which is often the first clue.
