...
### Intro
As you will be interacting with the control station GUI for most of the lab, it is important for you to understand how it works and how to interface with it. To start the GUI, following the instructions from the [setup guide](/docs/legacy-guides/armlab/setup-guide#to-launch-everything).

The control_station program launches three threads:

<a class="image-link" href="/assets/images/armlab-legacy/software/architecture.png">
<img src="/assets/images/armlab-legacy/software/architecture.png" alt="Overview of the software architecture" style="max-width:600px;"/>
</a>
...
1. Manual Mode
    ...
    <a class="image-link" href="/assets/images/armlab-legacy/checkpoints/checkpoint1-motion.png">
    <img src="/assets/images/armlab-legacy/checkpoints/checkpoint1-motion.png" alt="" style="max-width:600px;"/>
    </a>
...
{: .required_for_report }
1) **Cycle Task:** Teach your robot to cycle swapping blocks at locations (-100, 225) and (100, 225) through an intermediate location at (250,75). Coordinates are in mm, relative to the world frame. See [the board diagram](/docs/legacy-guides/armlab/checkpoints#board). <br>
