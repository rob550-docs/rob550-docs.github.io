---
layout: default
title: Fetch updates from upstream repo
nav_order: 12
...
1. First, commit and push your local changes to synchronize them with the cloud. Then, click the `Update fork` button on the webpage of your team's repository. GitLab will automatically fetch and merge everything for you on the remote side. 
    <a class="image-link" href="/assets/images/armlab-legacy/setup-guide/update-fork.png">
    <img src="/assets/images/armlab-legacy/setup-guide/update-fork.png" alt="" style="max-width:600px;"/>
    </a>
