...
<a class="image-link" href="/assets/images/armlab-legacy/setup-guide/gitlab_login.png">
<img src="/assets/images/armlab-legacy/setup-guide/gitlab_login.png" alt="" style="max-width:300px;"/>
</a>
...
4. Change the visibility level to "Private".
    ...
    <a class="image-link" href="/assets/images/armlab-legacy/setup-guide/fork_project.png">
    <img src="/assets/images/armlab-legacy/setup-guide/fork_project.png" alt="" style="max-width:500px;"/>
    </a>
    
### 4. Clone to local
1. Go to your group’s armlab repository webpage and copy the URL of “Clone with HTTPS”

    <a class="image-link" href="/assets/images/armlab-legacy/setup-guide/clone.png">
    <img src="/assets/images/armlab-legacy/setup-guide/clone.png" alt="" style="max-width:400px;"/>
    </a>
...
```
    ...
    {: .note}
    The commands we use here are known as **Linux command line tools**. Understanding the basics of Linux CLT is essential for smooth progress in this class. If you are not familiar with it, [this post](/docs/legacy-guides/armlab/how-to-guide/linux-clt) provides some basic information you need to know. 
...
<a class="image-link" href="/assets/images/armlab-legacy/setup-guide/interbotix_install.png">
<img src="/assets/images/armlab-legacy/setup-guide/interbotix_install.png" alt="" style="max-width:600px;"/>
</a>
...
<a class="image-link" href="/assets/images/armlab-legacy/setup-guide/testing-gui.png">
<img src="/assets/images/armlab-legacy/setup-guide/testing-gui.png" alt="" style="max-width:600px;"/>
</a>
